...
resource "github_repository" "managed" {
  name        = "likvid-mobile-new-banking-service-number-eight"
...
module "github_actions_sa" {
  ...
  project_id = "likvid-mobile-new-bankin-ulr"

  names        = ["githubactionssa"]
  display_name = "Github Actions SA"

  project_roles = ["likvid-mobile-new-bankin-ulr=>roles/owner"]
}
...
module "gh_oidc" {
  ...
  sa_mapping     = {
    "my_service_account" = {
      sa_name   = "projects/likvid-mobile-new-bankin-ulr/serviceAccounts/${module.github_actions_sa.email}"
      attribute = "attribute.repository/likvid-bank/number-eight"
    }
  }
}
